...
Eventually though I found the file path where substance stores it, should be at `\Program Files\Adobe\Adobe Substance 3D Painter\resources\python-doc\substance_painter` for most.
